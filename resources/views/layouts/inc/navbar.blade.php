                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @elseif(Auth::guard('vendor')->check())
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    {{  Auth::guard('vendor')->user()->firstname.' '.Auth::guard('vendor')->user()->lastname.(Auth::guard('vendor')->user()->site ? ' - @'.Auth::guard('vendor')->user()->site->slug : '')  }} <span class="caret"></span>
                                </a>

                                <ul class="dropdown-menu" role="menu">
								@if(Auth::guard('vendor')->user()->site)
									<li>
									...
									<li>
										<a href="{{ route('vendor.dashboard',['slug' => Auth::guard('vendor')->user()->site->slug]) }}">
											Dashboard
										</a>
									</li>
								@endif
